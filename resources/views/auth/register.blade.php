        ...
        <form action="{{route('register')}}" method="POST" novalidate>  <!--Esto funciona para que este formulario tenga una accion y se pueda cargar la infor desde las peticiones tipo post-->
           @csrf <!--Esto hace que se comniqyue perfectamente con las peticiones -->
            ...
            <div class="mb-5">
                ...
                <input id="username" name="username" type="text" placeholder="Nombre de usuario" class="border p-3 w-full rounded-lg @error('name') border-red-500 @enderror" 
                value= "{{old('name')}}" >
            ...
            <div class="mb-5">
                ...
                <input id="email" name="email" type="email" placeholder="Ingresa tu email" class="border p-3 w-full rounded-lg @error('name') border-red-500 @enderror" 
                value= "{{old('name')}}">
