...
<div class="md:flex md:justify-center md:gap-10 md:items-center "> <!--p-5 es el paddign  --> 
    ...
    <div class="md:w-4/12 bg-white p-6 rounded-lg shadow-xl"> <!--Crea una sombra shadow -->
        <form action="{{route('register')}}" method="POST">  <!--Esto funciona para que este formulario tenga una accion y se pueda cargar la infor desde las peticiones tipo post-->
           @csrf <!--Esto hace que se comniqyue perfectamente con las peticiones -->
            ...
            <div class="mb-5">
                ...
                <input id="email" name="email" type="email" placeholder="Ingresa tu email" class="border p-3 w-full rounded-lg">
            </div>
            <div class="mb-5">
